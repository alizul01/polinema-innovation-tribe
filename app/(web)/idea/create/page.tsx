    ...
    <div className={"w-full sm:items-center justify-center xl:px-56 gap-12 text-white flex flex-col relative"}>
      <div className={"flex gap-4 flex-col p-4 sm:max-w-[92rem] w-full"}>
        ...
        <div className={"flex flex-col md:flex-row gap-2"}>
          ...
          <div className={"p-2 bg-slate-800 hover:ring-purple-600 transition-all ease-in-out duration-500 rounded-md flex flex-col sticky top-16 gap-6 md:w-[35%] h-full hover:ring-2"}>
            <div>
