  ...
  return (
    ...
    >
      ...
      <div className={"text-center"}>
        <h4 className={"text-blue-300 font-regular text-md"}>Register to</h4>
        <h1 className={"text-white text-xl font-bold"}>
          Polinema Innovation Tribe
        </h1>
      </div>
      <div className={"fixed text-white bg-red-900"}></div>
      <form
      ...
      >
        ...
        <input
          className={
            "focus:outline-none flex w-full text-center justify-center items-center cursor-pointer text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 my-6 bg-purple-600 hover:bg-purple-700 transition-all duration-500 ease-in-out hover:scale-95 focus:ring-purple-900"
          }
          type={"submit"}
        />
