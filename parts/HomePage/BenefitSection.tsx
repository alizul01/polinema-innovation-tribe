...
const BenefitSection: React.FC = () => {
  return (
    <section
      className="w-full pt-2 gap-3 flex flex-col items-center justify-center"
      id="benefit"
    >
      <div className={"max-w-4xl text-center flex flex-col gap-3"}>
        <div>
