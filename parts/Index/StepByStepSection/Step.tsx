  ...
  return (
    ...
    >
      ...
      <div className={"pb-24"}>
        <h1
          className={
            "font-extrabold md:text-6xl p-3 text-transparent text-center text-3xl bg-clip-text bg-gradient-to-r from-purple-400 to-blue-500"
          }
        >
          {" "}
          ...
          <span
            className={
              "md:text-7xl text-transparent text-center text-3xl bg-clip-text bg-gradient-to-r from-gray-50 to-slate-100"
            }
          >
            Something Big
          </span>{" "}
      ...
      <span
        className={
          "from-red-500 bg-gradient-to-t to-red-700 from-blue-500 to-blue-700 from-green-500 to-green-700 hidden"
        }
      >
      ...
      <div className={"flex flex-col gap-2"}>
        <div className={"flex flex-col gap-2"}>
          <h1
            className={"mb-12 font-bold md:text-3xl text-transparent text-center text-xl bg-clip-text bg-gradient-to-r from-purple-400 to-purple-400"}>
            Create
          </h1>
        ...
        <div
          className={
            "flex flex-col md:flex-row justify-between w-full gap-2 p-2"
          }
        >
          <span
            className={"w-full md:w-[60%] flex justify-center items-center"}
          >
            <Idea className={"w-full float-animation"}/>
          </span>
          <div>
            <span
              className={"flex p-4 w-full flex-col items-start justify-start"}
            >
              <h1
                className={
                  "text-white font-bold text-2xl text-center md:text-start w-full md:text-4xl"
                }
              >
                How to Create Idea?
              </h1>
              <span className={"md:pl-8 pl-2 pt-4"}>
                <ol className="relative border-l border-gray-700">
                  <li className="mb-10 ml-4">
                    <div
                      className="absolute w-3 h-3 rounded-full mt-1.5 -left-1.5 border border-gray-900 bg-gray-700"></div>
                    ...
                    <p className="mb-4 text-base font-normal text-gray-400">
                      It's a good start if you start from Sustainable
                      Development Goal's (SDGs) Problem!
                    </p>
                    <Link
                  ...
                  <li className="mb-10 ml-4">
                    ...
                    <p className="mb-4 text-base font-normal text-gray-400">
                      Try to break down each problem and create a solution for
                      each piece of the problem
                    </p>
                    <Link
                      target={"_blank"}
      ...
      {/*team up*/}
      <div
        className="w-full py-2 md:py-8 flex flex-col items-center justify-center relative"
        id="step"
      >
        <LineCircle
          fromColor={"blue"}
      ...
      <div className={"flex flex-col gap-2"}>
        <div className={"flex flex-col gap-2"}>
          <h1
            className={
              "mb-12 font-bold md:text-3xl text-transparent text-center text-xl bg-clip-text bg-gradient-to-r from-blue-400 to-blue-500"
            }
          >
            Team Up
          </h1>
          <h2
            className={
              "font-bold md:text-7xl text-slate-50 text-center text-3xl"
            }
          >
            Search Team At Here!
          </h2>
        ...
        <div
          className={
            "flex flex-col md:flex-row-reverse justify-between w-full gap-2 p-2"
          }
        >
          <span
            className={"w-full md:w-[70%] flex justify-center items-center"}
          >
            <TeamUp className={"w-full float-animation"}/>
          </span>
          <div>
            <span
              className={"flex p-4 w-full flex-col items-start justify-start"}
              ...
              <span className={"md:pl-8 pl-2 pt-4"}>
                <ol className="relative border-l border-gray-700">
                  <li className="mb-10 ml-4">
                    ...
                    <p className="mb-4 text-base font-normal text-gray-400">
                      Wait for someone to request to join your group or invite
                      them to be a member
                    </p>
                    <Link
                      href="/idea"
                  ...
                  <li className="mb-10 ml-4">
                    ...
                    <p className="mb-4 text-base font-normal text-gray-400">
                      Find an interesting idea and request to become a member of
                      the idea team
                    </p>
                    <Link
                      target={"_blank"}
      ...
      <div className={"flex flex-col gap-2"}>
        <div className={"flex flex-col gap-2"}>
          <h1
            className={
              "mb-12 font-bold md:text-3xl text-transparent text-center text-xl bg-clip-text bg-gradient-to-r from-red-400 to-red-500"
            }
          >
            Compete
          </h1>
          <h2
            className={
              "font-bold md:text-8xl text-slate-50 text-center text-3xl"
            }
          >
            Search Competition
          </h2>
      ...
      <div
        className="gradient-01 -z-[99] absolute h-[20%] w-[20%] bottom-0 right-0 opacity-30 md:opacity-20 rounded-full"/>
    </section>
  );
};
